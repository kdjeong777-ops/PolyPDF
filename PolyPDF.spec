...
binaries = [('ffmpeg.exe', '.')]
hiddenimports = ['PyQt6.QtMultimedia', 'PyQt6.QtMultimediaWidgets', 'viewer', 'viewer.app', 'viewer.history', 'viewer.indexer', 'viewer.pdf_doc', 'viewer.screenshot', 'viewer.settings_store', 'viewer.workers', 'viewer.updater', 'viewer.components', 'viewer.resources_path', 'viewer.global_hotkey', 'viewer.bookmarker_bridge', 'viewer._vendor', 'viewer._vendor.pdf_bookmarker', 'viewer._vendor.pdf_bookmarker.core', 'viewer._vendor.pdf_bookmarker.auto', 'viewer._vendor.pdf_bookmarker.toc_extractor', 'viewer._vendor.pdf_bookmarker.font_extractor', 'viewer._vendor.pdf_bookmarker.pdf_writer', 'viewer.widgets', 'viewer.widgets.bookmark_tree', 'viewer.widgets.main_view', 'viewer.widgets.search_panel', 'viewer.widgets.settings_dialog', 'viewer.widgets.help_dialog', 'viewer.widgets.favorites_dialog', 'viewer.widgets.strip', 'viewer.widgets.thumbs_list', 'viewer.widgets.bookmarker_dialog', 'viewer.widgets.screenshot_pdf_dialog', 'viewer.widgets.study_panel', 'viewer.widgets.study_edit_dialog', 'viewer.widgets.flow_layout', 'viewer.widgets.read_aloud', 'viewer.widgets.print_dialog', 'viewer.widgets.image_to_pdf_dialog', 'viewer.study', 'viewer.study.ocr', 'viewer.study.vocab', 'viewer.study.study_store', 'viewer.study.dict_store', 'viewer.study.glossary_import', 'viewer.study.term_spotter', 'viewer.study.dict_export', 'viewer.study.image_fetch', 'viewer.study.online_dict', 'viewer.study.law_api', 'viewer.widgets.law_search_dialog', 'viewer.study.kcsc_api', 'viewer.widgets.kcsc_search_dialog', 'viewer.study.kipo_api', 'viewer.widgets.kipo_search_dialog', 'viewer.study.translate_api', 'viewer.study.pdf_extract', 'viewer.study.glossary_build', 'viewer.study.glossary_folder', 'viewer.study.summarize', 'viewer.study.pdf_assets', 'viewer.widgets.dict_manager_dialog', 'viewer.widgets.glossary_edit_dialog', 'viewer.tag_store', 'viewer.widgets.tag_edit_dialog', 'viewer.widgets.content_find', 'viewer.widgets.content_find_overlay', 'viewer.study.export_translation', 'viewer.study.ant_cli', 'viewer.widgets.translate_dialog', 'viewer.widgets.translate_files_dialog', 'viewer.widgets.toggle_splitter', 'viewer.widgets.icons', 'viewer.widgets.image_search_dialog', 'viewer.study.tts', 'viewer.study.export_docx', 'viewer.study.mp3_export', 'pytesseract', 'wordfreq', 'nltk', 'kiwipiepy', 'kiwipiepy_model', 'docx', 'lameenc', 'win32com', 'win32com.client', 'pythoncom', 'pywintypes', 'openpyxl', 'openpyxl.cell._writer', 'send2trash']
